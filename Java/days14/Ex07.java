...
public class Ex07 {
	...
	public static void main(String[] args) {
		...
		//2.정적(static) 메서드 언제 사용하는지?
		//    1)객체 생성 전에 private static 멤버에 접근하려면 static으로 선언된 메서드가 필요(결론 : save 클래스의 static 필드를 사용하기 위해서 static 메서드가 필요하다.)
		...
		*/
		...
		//Save 클래스 당 한개만 rate 필드를 생성해서 모든 인스턴스(객체)가 공유해서 사용할 필드를 선언하면 될 것 같음
