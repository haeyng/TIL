...
public final class SalesMan extends Regular{
	...
	public SalesMan(String name, String addr, String tel, 
			String hiredate, int basePay,int sales, int comm) {
	...
	System.out.printf("사원명:%s, 주소:%s, 연락처:%s, 입사일자:%s, 기본급:%d, 판매량:%d, 커미션:%d\n",
			this.getName(),this.getAddr(),this.getAddr(),this.getTel(),this.getBasePay(),this.sales,this.comm);	
	}
